...
const REMOTE_VPN_LINK = process.env.NEXT_PUBLIC_REMOTE_VPN_LINK || '/downloads/Remote-VPN-Software.zip';
const VHUI64_LINK = process.env.NEXT_PUBLIC_VHUI64_LINK || '/downloads/VHUI64-Software.zip';
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '12px', marginBottom: '20px' }}>
        ...
        >
          <div><div style={{ color: '#60a5fa', fontSize: '12px', fontWeight: '800' }}>🔐 REMOTE / VPN SOFTWARE</div><div style={{ color: '#cbd5e1', fontSize: '11px', marginTop: '4px' }}>Direct software download</div></div><span style={{ color: '#60a5fa', fontSize: '12px', fontWeight: '800' }}>DOWNLOAD ↓</span>
        ...
        >
          <div><div style={{ color: '#c084fc', fontSize: '12px', fontWeight: '800' }}>🛠️ VHUI64 SOFTWARE</div><div style={{ color: '#cbd5e1', fontSize: '11px', marginTop: '4px' }}>Direct software download</div></div><span style={{ color: '#c084fc', fontSize: '12px', fontWeight: '800' }}>DOWNLOAD ↓</span>
