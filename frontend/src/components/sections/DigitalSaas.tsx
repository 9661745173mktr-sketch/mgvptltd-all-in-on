...
export default function DigitalSaas({ handleOpenForm }: any) {
  const saasServices = [
    { id: 'saas-1', title: 'SaaS & Custom ERP Solutions', fee: '₹299', icon: '💻', color: '#6366f1', info: 'Deploy automated business billing, CRM, and mobile apps.' },
    { id: 'saas-2', title: 'Cloud Hosting & Domain Registry', fee: '₹299', icon: '☁️', color: '#3b82f6', info: 'Register domains and setup high-speed SSD cloud hosting.' },
  ];

  return (
    <div>
      <div style={{ marginBottom: '20px' }}>
        <h2 style={{ fontSize: '18px', fontWeight: '800', color: '#f8fafc' }}>Digital SaaS Solutions</h2>
      </div>
