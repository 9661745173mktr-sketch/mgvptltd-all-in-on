...
export default function TravelBookings({ handleOpenForm }: any) {
  const travelServices = [
    { id: 'travel-1', title: 'Flight & Hotel Bookings', fee: '₹50', icon: '✈️', color: '#0ea5e9', info: 'Book domestic/international flights and hotels at lowest agent fares.' },
    { id: 'travel-2', title: 'IRCTC Train Ticket Booking', fee: '₹15', icon: '🚆', color: '#f59e0b', info: 'Authorized IRCTC rail ticketing agent portal with fast Tatkal support.' },
  ];

  return (
    <div>
      <div style={{ marginBottom: '20px' }}>
        <h2 style={{ fontSize: '18px', fontWeight: '800', color: '#f8fafc' }}>Travel Bookings Portal</h2>
      </div>
