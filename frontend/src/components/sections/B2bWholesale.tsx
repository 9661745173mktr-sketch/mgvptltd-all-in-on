...
export default function B2bWholesale({ handleOpenForm }: any) {
  const b2bServices = [
    { id: 'b2b-1', title: 'B2B Wholesale Marketplace', fee: '₹100', icon: '📦', color: '#f59e0b', info: 'Direct manufacturer bulk catalog, MCU cards, and accessories store.' },
    { id: 'b2b-2', title: 'Bulk Printing & Packaging', fee: '₹100', icon: '🏷️', color: '#3b82f6', info: 'Commercial flyers, visiting cards, and custom packaging boxes.' },
  ];

  return (
    <div>
      <div style={{ marginBottom: '20px' }}>
        <h2 style={{ fontSize: '18px', fontWeight: '800', color: '#f8fafc' }}>B2B Wholesale Hub</h2>
      </div>
